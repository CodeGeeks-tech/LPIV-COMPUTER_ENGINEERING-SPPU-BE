...
Enter 2x2 matrix values:
Row 1 (space-separated): 1 2
Row 2 (space-separated): 3 4

--- Matrix B ---
Enter number of rows: 2
Enter number of columns: 2
Enter 2x2 matrix values:
Row 1 (space-separated): 5 6
Row 2 (space-separated): 7 8
...
Sequential:      0.0001s
Thread per row:  0.0003s (Speedup: 0.33x)
Thread per cell: 0.0005s (Speedup: 0.20x)
